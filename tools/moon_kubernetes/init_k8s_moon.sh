...
function wait_for_kubernate_calico() {
  ...
  declare -a kube_pods=("calico-etcd 1" "calico-node 2" "calico-policy-controller 1" "etcd-debian 1" "kube-apiserver-debian 1" "kube-controller-manager-debian 1" "kube-dns 3" "kube-proxy 1" "kube-scheduler-debian 1")
