...
RULES = [{"rules": [{"meta_rule": {"name": "unknown meta rule"}, "policy": {"name": "test policy"}, "instructions": {"decision": "grant"}, "enabled": True, "rule": {"subject_datas": [{"name": "subject data"}], "object_data": {"name": "object data"}, "action_data": {"name": "action data"}}}]},
         {"rules": [{"meta_rule": {"name": "good meta rule"}, "policy": {"name": "unknown policy"}, "instructions": {"decision": "grant"}, "enabled": True, "rule": {"subject_datas": [{"name": "subject data"}], "object_data": {"name": "object data"}, "action_data": {"name": "action data"}}}]},
         {"rules": [{"meta_rule": {"name": "good meta rule"}, "policy": {"name": "test policy"}, "instructions": {"decision": "grant"}, "enabled": True, "rule": {"subject_datas": [{"name": "unknown subject data"}], "object_data": {"name": "object data"}, "action_data": {"name": "action data"}}}]},
         {"rules": [{"meta_rule": {"name": "good meta rule"}, "policy": {"name": "test policy"}, "instructions": {"decision": "grant"}, "enabled": True, "rule": {"subject_datas": [{"name": "subject data"}], "object_data": {"name": "unknown object data"}, "action_data": {"name": "action data"}}}]},
         {"rules": [{"meta_rule": {"name": "good meta rule"}, "policy": {"name": "test policy"}, "instructions": {"decision": "grant"}, "enabled": True, "rule": {"subject_datas": [{"name": "subject data"}], "object_data": {"name": "object data"}, "action_data": {"name": "unknown action data"}}}]},
         {"rules": [{"meta_rule": {"name": "good meta rule"}, "policy": {"name": "test policy"}, "instructions": {"decision": "grant"}, "enabled": True, "rule": {"subject_datas": [{"name": "subject data"}], "object_data": {"name": "object data"}, "action_data": {"name": "action data"}}}]}]
