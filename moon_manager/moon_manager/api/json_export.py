    ...
    def _export_rules(self, json_content):
        ...
        for policy_key in policies:
            ...
            for rule in rules:
                ...
                JsonUtils.convert_ids_to_names( [ids[0]], rule_description, "subject_datas", "subject_data",  PolicyManager, self._user_id, policy_key)
                JsonUtils.convert_id_to_name(ids[1], rule_description, "object_data", "object_data", PolicyManager, self._user_id, policy_key)
                JsonUtils.convert_id_to_name(ids[2], rule_description, "action_data", "action_data", PolicyManager, self._user_id, policy_key)
